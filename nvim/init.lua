-- TODO: These are the things to do. (Just for reminding things)
-- Line 576 - Changed Pyright analysis
-- line 346 - CONTINUE
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- I do not use neovim for C++, development. For C++, java and typescript, i use vim.

        -- clangd = {
        --   -- the unused parameter in the function below is to be revisited
