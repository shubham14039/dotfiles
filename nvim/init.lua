-- Set the python host progeram
vim.g.python3_host_prog = '/opt/homebrew/opt/python@3.13/Frameworks/Python.framework/Versions/3.13/bin/python3.13'
...
-- Auto save when loosing the edited files
...
-- NOTE: This might not work in all terminal emulators. In that case, try your own mapping.
...
-- [[ Basic Autocommands ]]
-- Highlight when copying (yanking) a text.
...
require('lazy').setup({
  ...
  {
    'glepnir/oceanic-material', -- ColorScheme
    lazy = false, -- Load immediately
    priority = 1000, -- To Ensure it loads early
    config = function()
      vim.o.background = 'dark'
    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- The following code creates a keymap to toggle inlay hints in your code, if your language server supports them
      ...
      --    :Mason
      --    Alternatively, you can always install other tools of your choice.
      require('mason').setup()
  ...
  { -- Autocompletion
    ...
    dependencies = {
      ...
      --  nvim-cmp does not ship with all sources by default. They are split into mulitple repos for maintainance
      'hrsh7th/cmp-nvim-lsp',
      'hrsh7th/cmp-path',
    },
    config = function()
